...
// 🆕 ADD THIS CHATBOT COMPONENT (before the main App function)
      ...
      <div style={{
        ...
        {loading && (
          <div style={{ display: 'flex', gap: '0.25rem', padding: '0.5rem' }}>
            ...
            <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#667eea', animation: 'bounce 1s infinite 0.4s' }} />
          </div>
        )}
      </div>
  ...
  return (
    <>
      ...
      <div className="dashboard-container">
        ...
        {/* 🆕 ADD CHATBOT BUTTON (after your dashboard content, before closing divs) */}
        {allAuditResults && (
          <>
            ...
            {/* Chatbot */}
            {showChatbot && (
              <AccessibilityChatbot onClose={() => setShowChatbot(false)} />
            )}
          </>
        )}
      </div>
